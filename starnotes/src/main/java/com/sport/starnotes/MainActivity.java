...
import com.sport.starnotes.databinding.ActivityMainBinding;
...
public class MainActivity extends WearableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new SendThread(datapath, "get_notes").start();
    ...
    public static String notes() {
        ...
        return preferences.getString("notes", "no notes synced yet");
    }
